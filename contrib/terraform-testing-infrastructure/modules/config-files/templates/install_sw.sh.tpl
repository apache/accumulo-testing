...
# Download, build, and install Accumulo
  ...
  ${software_root}/apache-maven/apache-maven-${maven_version}/bin/mvn -s ${software_root}/apache-maven/settings.xml clean package -DskipTests -DskipITs
  mkdir -p ${software_root}/accumulo
...
pdsh -R exec -g worker rsync -az \
  --exclude=${software_root}/conf/*** \
  --exclude=${software_root}/apache-maven/*** \
  --exclude=${software_root}/accumulo_repo/*** \
  ${software_root}/ %h:${software_root}/
