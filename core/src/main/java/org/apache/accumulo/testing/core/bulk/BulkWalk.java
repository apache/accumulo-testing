...
public class BulkWalk {
  ...
  public static void main(String[] args) throws Exception {
    ...
    int sleepTime = Integer.parseInt(props.getProperty(TestProps.BL_WALKER_SLEEP_MS));

    while (true) {
      Scanner scanner = BulkUtil.createScanner(conn, env.getAccumuloTableName(), env.getRandomAuthorizations());
