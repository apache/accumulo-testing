...
public class Verify extends Test {
  ...
  public void visit(State state, RandWalkEnv env, Properties props) throws Exception {
    ...
    String failDir = state.getString("fail");

    log.info("Finished BadFile test. Used {} bulk import.", useLegacyBulk ? "legacy" : "new");
    log.info("Table: {} badFile: {} wroteBadFile: {} bulk directory: {} fail: {}", tableName,
        badFile, wroteBadFile, dir, failDir);
  }
}
